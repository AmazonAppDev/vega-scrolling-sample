...
class TestRunner:
    ...
    def run(self) -> None:
        press_key(self.__driver, KeyEvents.RIGHT, repetitions= 15)
        press_key(self.__driver, KeyEvents.LEFT, repetitions= 7)
        press_key(self.__driver, KeyEvents.RIGHT, holdDuration=7000, delay=1)
        press_key(self.__driver, KeyEvents.LEFT, holdDuration=8000, delay=1)

...
class TestRunner:
    ...
    def run(self) -> None:
        press_key(self.__driver, KeyEvents.RIGHT, repetitions=10)
        press_key(self.__driver, KeyEvents.RIGHT, holdDuration=7000, delay=1)
        press_key(self.__driver, KeyEvents.DOWN)

        press_key(self.__driver, KeyEvents.DOWN, repetitions=4)
        press_key(self.__driver, KeyEvents.DOWN, holdDuration=4000, delay=1)

        press_key(self.__driver, KeyEvents.RIGHT, holdDuration=6500, delay=1)
        press_key(self.__driver, KeyEvents.LEFT, repetitions=10)
        ...

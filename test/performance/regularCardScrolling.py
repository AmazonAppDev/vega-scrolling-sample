...
class TestRunner:
    ...
    def prep(self) -> None:
        press_key(self.__driver,KeyEvents.DOWN, delay=1)
        press_key(self.__driver,KeyEvents.DOWN, delay=1)
        press_key(self.__driver,KeyEvents.DOWN, delay=1)
        ...
 
    def run(self) -> None:
        press_key(self.__driver,KeyEvents.RIGHT, repetitions = 8)
        press_key(self.__driver,KeyEvents.RIGHT, repetitions = 12, delay = 0.3)
        press_key(self.__driver,KeyEvents.LEFT, repetitions = 8)
        press_key(self.__driver,KeyEvents.LEFT, repetitions = 8, delay = 0.3)
        press_key(self.__driver,KeyEvents.RIGHT, holdDuration = 5000, delay = 1)
        press_key(self.__driver,KeyEvents.LEFT, holdDuration = 5000, delay = 1)
        ...
